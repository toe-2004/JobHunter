...
class FreelancerControllerTest {
    ...
    void saveProfile_createsProfileLinkedToCurrentUserAndAssignsFreelancerRole() throws Exception {
        ...
        TestingAuthenticationToken auth = new TestingAuthenticationToken("user@test", null);
        ...
        String result = freelancerController.createFreelancer( profile, null, null, auth);

        assertEquals("redirect:/freelancer/profile", result);
